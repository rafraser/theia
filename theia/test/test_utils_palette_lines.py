import unittest
from theia.palettes import parse_palette_lines
...
palette_test_rgb = """
/* This is an example of using rgb() instead of hex colors
red: rgb(231, 76, 60)
blue: rgb(52, 152, 219)
"""
...
class TestPaletteLines(unittest.TestCase):
    @staticmethod
    def parse(p):
        return parse_palette_lines(p.splitlines())
    ...
    def test_rgb(self):
        self.assertEqual(self.parse(palette_test_rgb), goal_named)
